...
public class FtpServiceEspressoTest {
  ...
  private void loginAndVerifyWith(final FTPClient ftpClient)
      throws IOException {
  ...
  private void testDownloadWith(final FTPClient ftpClient) throws IOException {
    File testFile1 =
        new File(Environment.getExternalStorageDirectory(), "test.txt");
    File testFile2 =
        new File(Environment.getExternalStorageDirectory(), "test.bin");
  ...
  private FtpService create() throws ReflectiveOperationException {
    ...
    Method attach = Service.class.getDeclaredMethod(
        "attach", Context.class, activityThreadClazz, String.class,
        IBinder.class, Application.class, Object.class);
    attach.invoke(service, InstrumentationRegistry.getTargetContext(), null,
                  service.getClass().getSimpleName(), null, null, null);
    return service;
  }
