...
/**
 * Worker fragment designed to not be destroyed when the activity holding it is
 * recreated (aka the state changes like screen rotation) thus maintaining alive
 * an AsyncTask (SearchTask in this case)
 *
...
public void onCreate(final Bundle savedInstanceState) {
	...
	OpenMode mOpenMode =
		OpenMode.getOpenMode(getArguments().getInt(KEY_OPEN_MODE));
	...
	mSearchAsyncTask =
		new SearchAsyncTask(getActivity(), mCallbacks, mInput, mOpenMode,
