...
public class FoldersPref
    ...
    if (preference instanceof PathSwitchPreference) {
      ...
      default:
        break;
                   ...
                   PreferencesConstants.PREFERENCE_SHORTCUT)) {
  ...
  private void loadCreateDialog() {
    ...
    final View v = li.inflate(R.layout.dialog_twoedittexts,
                              null); // TODO: 29/4/2017 make this null not null
    ((TextInputLayout)v.findViewById(R.id.text_input1))
        .setHint(getString(R.string.name));
    ((TextInputLayout)v.findViewById(R.id.text_input2))
        .setHint(getString(R.string.directory));
    ...
    dialog.getActionButton(DialogAction.POSITIVE).setOnClickListener(view -> {
      ...
      utilsHandler.saveToDatabase(
          new OperationData(UtilsHandler.Operation.BOOKMARKS,
  ...
  private void loadEditDialog(final PathSwitchPreference p) {
        ...
        new MaterialDialog.Builder(getActivity())
            ...
            .positiveText(
                getString(R.string.edit)
                    .toUpperCase()) // TODO: 29/4/2017 don't use toUpperCase()
            .negativeColor(fab_skin)
            .negativeText(android.R.string.cancel)
            .customView(v, false)
            .build();
    ...
    dialog.getActionButton(DialogAction.POSITIVE)
        .setEnabled(FileUtils.isPathAccessible(editText2.getText().toString(),
                                               sharedPrefs));
  ...
  private void loadDeleteDialog(final PathSwitchPreference p) {
    ...
    dialog.getActionButton(DialogAction.POSITIVE).setOnClickListener(view -> {
      ...
      utilsHandler.removeFromDatabase(new OperationData(
          UtilsHandler.Operation.BOOKMARKS, p.getTitle().toString(),
  ...
  private void disableButtonIfNotPath(final EditText path,
                                      final MaterialDialog dialog) {
  ...
  private void disableButtonIfTitleEmpty(final EditText title,
                                         final MaterialDialog dialog) {
