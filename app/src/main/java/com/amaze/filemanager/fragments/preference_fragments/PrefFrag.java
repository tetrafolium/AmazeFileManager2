...
public class PrefFrag
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2 ||
        sharedPref.getBoolean(PreferencesConstants.PREFERENCE_CRYPT_FINGERPRINT,
                              false)) {
    ...
    CheckBox checkBoxFingerprint = (CheckBox)findPreference(
    ...
    try {
      ...
      final FingerprintManager fingerprintManager =
          (FingerprintManager)getActivity().getSystemService(
              Context.FINGERPRINT_SERVICE);

      final KeyguardManager keyguardManager =
          (KeyguardManager)getActivity().getSystemService(
          ...
          (preference, newValue) -> {
            if (ActivityCompat.checkSelfPermission(
              ...
              Toast
                  .makeText(getActivity(),
                            getResources().getString(
                                R.string.crypt_fingerprint_no_permission),
                            Toast.LENGTH_LONG)
                  .show();
              return false;
              ...
              Toast
                  .makeText(getActivity(),
                            getResources().getString(
                                R.string.crypt_fingerprint_not_enrolled),
                            Toast.LENGTH_LONG)
                  .show();
              return false;
            } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
  ...
  public boolean onPreferenceClick(Preference preference) {
    ...
    case PreferencesConstants.PREFERENCE_GRID_COLUMNS:
      ...
      int current = Integer.parseInt(sharedPref.getString(
          PreferencesConstants.PREFERENCE_GRID_COLUMNS, "-1"));
      current = current == -1 ? 0 : current;
      if (current != 0)
        current = current - 1;
      builder.items(sort).itemsCallbackSingleChoice(
          current, (dialog, view, which, text) -> {
            sharedPref.edit()
                .putString(PreferencesConstants.PREFERENCE_GRID_COLUMNS,
    ...
    case PreferencesConstants.FRAGMENT_THEME:
      ...
      builder.items(sort).itemsCallbackSingleChoice(
          current, (dialog, view, which, text) -> {
            utilsProvider.getThemeManager().setAppTheme(
                AppTheme.getTheme(which));
            dialog.dismiss();
    ...
    case PreferencesConstants.FRAGMENT_FEEDBACK:
      ...
      if (isIntentSafe)
        startActivity(Intent.createChooser(emailIntent,
                                           getResources().getString(feedback)));
      else
        Toast
            .makeText(getActivity(),
                      getResources().getString(R.string.send_email_to) +
    ...
    case PreferencesConstants.PREFERENCE_CRYPT_MASTER_PASSWORD:
      ...
      try {
        String preferencePassword = sharedPref.getString(
      ...
      masterPasswordDialogBuilder.theme(
          utilsProvider.getAppTheme().getMaterialDialogTheme());
      masterPasswordDialogBuilder.positiveText(
          getResources().getString(R.string.ok));
      masterPasswordDialogBuilder.negativeText(
          getResources().getString(R.string.cancel));
      masterPasswordDialogBuilder.positiveColor(
          ((ThemedActivity)getActivity()).getAccent());
      ...
      masterPasswordDialogBuilder.onNegative(
  ...
  public void onResume() {
    ...
    if (listView != null) {
      /**This is a hack see {@link PreferencesActivity#saveListViewState(int,
       * Parcelable)}*/
      Parcelable restored = ((PreferencesActivity)getActivity())
                                .restoreListViewState(START_PREFERENCE);
      if (restored != null) {
