...
public class CloudEntry {
  ...
  public void setId(final int _id) { this._id = _id; }
  ...
  public String getPersistData() { return this.persistData; }
  ...
  /**
   * Returns ordinal value of service from {@link
   * com.amaze.filemanager.utils.OpenMode}
   */
  public OpenMode getServiceType() { return this.serviceType; }
}
