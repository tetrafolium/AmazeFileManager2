...
public class RenameBookmark extends DialogFragment {
  ...
  public static RenameBookmark getInstance(final String name, final String path,
  ...
  public Dialog onCreateDialog(final Bundle savedInstanceState) {
    ...
    if (dataUtils.containsBooks(new String[] {title, path}) != -1) {
      ...
      builder.theme(((BasicActivity)getActivity())
                        .getAppTheme()
                        .getMaterialDialogTheme());
      builder.autoDismiss(false);
      View v2 =
          getActivity().getLayoutInflater().inflate(R.layout.rename, null);
      ...
      final String s1 =
          getString(R.string.cantbeempty, c.getString(R.string.name));
      final String s2 =
          getString(R.string.cantbeempty, c.getString(R.string.path));
