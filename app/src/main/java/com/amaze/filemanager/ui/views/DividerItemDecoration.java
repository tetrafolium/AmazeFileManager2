...
public DividerItemDecoration(final Context context,
                             final boolean showtopbottomdividers,
                             final boolean show) {
 ...
 * Be advised - divider will be drawn before the views, hence it'll be below
 * the views of adapter
 */
private void drawVertical(final Canvas c, final RecyclerView parent) {
	final int left = parent.getPaddingLeft() + leftPaddingPx;
	final int right =
		parent.getWidth() - parent.getPaddingRight() - rightPaddingPx;
