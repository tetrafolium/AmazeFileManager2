...
public WarnableTextInputValidator(
	...
	final WarnableTextInputLayout textInputLayout, final View positiveButton,
	final OnTextValidate validator) {
	mContext = context;
	mEditText = editText;
...
public interface OnTextValidate { ReturnState isTextValid(String text); }

public static class ReturnState {
public static final int STATE_NORMAL = 0, STATE_ERROR = -1,
                        STATE_WARNING = -2;
