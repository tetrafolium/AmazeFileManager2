...
/**
 * Created by vishal on 8/4/17 edited by Emmanuel Messulam
...
public class EncryptService extends AbstractProgressiveService {
  ...
  public static final String TAG_SOURCE =
      "crypt_source"; // source file to encrypt or decrypt
  public static final String TAG_ENCRYPT_TARGET =
      "crypt_target"; // name of encrypted file
  ...
  public int onStartCommand(final Intent intent, final int flags,
    ...
    OpenMode openMode = OpenMode.values()[intent.getIntExtra(
        TAG_OPEN_MODE, OpenMode.UNKNOWN.ordinal())];
    notificationManager =
    ...
    NotificationCompat.Action action = new NotificationCompat.Action(
        R.drawable.ic_folder_lock_white_36dp, getString(R.string.stop_ftp),
        stopPendingIntent);

    notificationBuilder = new NotificationCompat.Builder(
        this, NotificationConstants.CHANNEL_NORMAL_ID);
    ...
    NotificationConstants.setMetadata(getApplicationContext(),
                                      notificationBuilder,
                                      NotificationConstants.TYPE_NORMAL);

    startForeground(NotificationConstants.ENCRYPT_ID,
  ...
  class BackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(final Void... params) {
      ...
      addFirstDatapoint(baseFile.getName(), 1, totalSize,
