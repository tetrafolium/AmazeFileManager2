 ...
 *
 * Created by Vishal on 05-02-2015 edited by Emmanuel
...
public class GenerateHashesTask extends AsyncTask<Void, String, String[]> {
  ...
  public GenerateHashesTask(final HybridFileParcelable f, final Context c,
                            final View view) {
    this.context = c;
    this.file = f;
            ...
            .makeText(
                ...
                context.getResources().getString(R.string.md5).toUpperCase() +
                    ...
                    context.getResources().getString(
                        R.string.properties_copied_clipboard),
                Toast.LENGTH_SHORT)
            .show();
        return false;
      });
