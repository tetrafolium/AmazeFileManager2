...
/**
 * {@link AsyncTask} for authenticating with SSH server to verify if parameters
 * are correct.
 *
 ...
 * @see
 *     com.amaze.filemanager.ui.dialogs.SftpConnectDialog#authenticateAndSaveSetup(String,
 *     String, int, String, String, String, String, KeyPair, boolean)
