...
public void onCreate(final Bundle savedInstanceState) {
	...
	if (SDK_INT >= 21) {
		ActivityManager.TaskDescription taskDescription =
			new ActivityManager.TaskDescription(
				"Amaze",
				((BitmapDrawable)ContextCompat.getDrawable(this,
	...
	boolean useNewStack = sharedPref.getBoolean(
	...
	if (SDK_INT == 20 || SDK_INT == 19) {
		...
		tintManager.setStatusBarTintColor(ColorPreferenceHelper.getPrimary(
							  getCurrentColorPreference(), MainActivity.currentTab));
		FrameLayout.MarginLayoutParams p =
			(ViewGroup.MarginLayoutParams)findViewById(R.id.parentdb)
			.getLayoutParams();
...
private void load(final File file) {
	new Thread(()->{
			...
			try {
			        ...
			        arrayAdapter =
					new ArrayAdapter(DatabaseViewerActivity.this,
