...
public class ApkImageDataFetcher implements DataFetcher<Drawable> {
  ...
  public ApkImageDataFetcher(final PackageManager packageManager,
                             final String model) {
  ...
  public void loadData(final Priority priority,
                       final DataCallback<? super Drawable> callback) {
  ...
  @Override
  public void cleanup() {
    // Intentionally empty only because we're not opening an InputStream or
    // another I/O resource!
  }
