 ...
 *
 * Borrowed from original AndroidConfig, but also use SpongyCastle from the
 * start altogether.
 *
...
public class CustomSshJConfig extends DefaultConfig {
  // This is where we different from the original AndroidConfig. Found it only
  // work if we remove BouncyCastle before registering SpongyCastle's provider
