...
public abstract class Decompressor {
  ...
  public Decompressor(final Context context) { this.context = context; }

  public void setFilePath(final String path) { filePath = path; }
  ...
  public abstract CompressedHelperTask changePath(
      String path, boolean addGoBackItem,
      OnAsyncTaskFinished<
   ...
   * @param subDirectories separator is "/", ended with "/" if it is a
   *     directory, does not if it's a file
   */
  public final void decompress(final String whereToDecompress,
  ...
  /**
   * Get the real relative directory path (useful if you converted the separator
   * or something)
   */
  protected String realRelativeDirectory(final String dir) { return dir; }
}
