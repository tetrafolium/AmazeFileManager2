...
/**
 * A little cache for archive passwords, backed by {@link Map<String, String>},
 * that only lives within the app's session, i.e. archive passwords won't be
 * saved to disk at all.
 *
 * It uses the path of the archive file as key and the password as the
 * corresponding value.
 *
 * Implemented especially for the convenience of 7z archives, which it's
 * possible to password-protect even the file/folder list of the archive. It is
 * not limited to 7z archives, of course.
 *
 ...
 * @see <a
 *     href="https://github.com/TeamAmaze/AmazeFileManager/pull/1391">DataUtils,
 *     which uses Bill Pugh's Singleton Implementation too</a>
 */
