...
public class SingletonUsbOtg {
  ...
  public boolean isDeviceConnected() { return connectedDevice != null; }
  ...
  public @Nullable Uri getUsbOtgRoot() { return usbOtgRoot; }

  public boolean checkIfRootIsFromDevice(final
                                         @NonNull UsbOtgRepresentation device) {
