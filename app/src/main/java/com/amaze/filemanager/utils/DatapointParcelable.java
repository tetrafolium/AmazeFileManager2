 ...
 * This class also acts as data carrier to communicate with {@link
...
public class DatapointParcelable implements Parcelable {
   ...
   * @param move allows changing the text from "Copying" to "Moving" in case of
   *     copy
   */
  public DatapointParcelable(final String name, final int amountOfSourceFiles,
                             final long totalSize, final boolean move) {
    this.name = name;
   ...
   */
  public DatapointParcelable(final String name, final int amountOfSourceFiles,
                             final int sourceProgress, final long totalSize,
                             final long byteProgress, final long speedRaw,
  ...
  /**
   * The same as {@link DatapointParcelable#DatapointParcelable(String, int,
   * int, long, long, long, boolean)} but allows move boolean to change the text
   * from "Copying" to "Moving" in case of copy.
   *
   * @param name name of source file being copied
   * @param amountOfSourceFiles total number of source files to be copied
   * @param sourceProgress which file is being copied from total number of files
  ...
  public DatapointParcelable(final String name, final int amountOfSourceFiles,
                             final int sourceProgress, final long totalSize,
                             final long byteProgress, final long speedRaw,
                             final boolean move, final boolean completed) {
    this.name = name;
    sourceFiles = amountOfSourceFiles;
    this.sourceProgress = sourceProgress;
    this.totalSize = totalSize;
