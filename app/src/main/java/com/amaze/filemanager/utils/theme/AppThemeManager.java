...
public class AppThemeManager {
  ...
  public AppThemeManager(final SharedPreferences preferences) {
    ...
    String themeId =
        preferences.getString(PreferencesConstants.FRAGMENT_THEME, "0");
   ...
   */
  public AppTheme getAppTheme() { return appTheme.getSimpleTheme(); }
  ...
  public AppThemeManager setAppTheme(final AppTheme appTheme) {
    ...
    preferences.edit()
        .putString(PreferencesConstants.FRAGMENT_THEME,
                   Integer.toString(appTheme.getId()))
        .apply();
    return this;
  }
}
