 ...
 *
 * Use this class when dealing with {@link
 * androidx.appcompat.widget.AppCompatEditText} for it's color states for
 * different user interactions
 */

public class EditTextColorStateUtil {

public static void setTint(final Context context, final EditText editText,
                           final int color) {
...
private static ColorStateList
createEditTextColorStateList(final Context context, final int color) {
