...
public class ComputerParcelableTest {
  ...
  /**
   * Purpose: when computerParcelable's name and object's name are not the same,
   * confirm that the two are different. Input:
   * computerParcelable.equals(object) only ComputerParcelable.addr ==
  ...
  /**
   * Purpose: when computerParcelable's address and object's address are not the
   * same, confirm that the two are different. Input:
   * computerParcelable.equals(object) only ComputerParcelable.name ==
  ...
  /**
   * Purpose: when computerParcelable's name/address and object's name/address
   * are not the same, confirm that the two are different. Input:
   * computerParcelable.equals(object) ComputerParcelable and Object not
   * same(name, address) Expected: result is false
   */
  @Test
