...
/**
 * Shadow of {@link Shell.Interactive}, for {@link
 * com.amaze.filemanager.filesystem.RootHelperTest}.
 *
 * Only tested for {@link
 * com.amaze.filemanager.filesystem.RootHelper#getFiles(String, boolean,
 * boolean, RootHelper.GetModeCallBack, OnFileFound)}, so only guarantees work
 * for that.
 *
 * <strong>DO NOT RUN THIS ON NON-UNIX OS. YOU SHOULD KNOW THIS
 * ALREADY.</strong>
 */
