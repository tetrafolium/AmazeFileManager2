...
throws GeneralSecurityException, IOException {
	String text = "test";
	String encrypted =
		CryptUtil.encryptPassword(RuntimeEnvironment.application, text);
	assertEquals(text, CryptUtil.decryptPassword(RuntimeEnvironment.application,
	                                             encrypted));
}
...
throws GeneralSecurityException, IOException {
	UtilsHandler utilsHandler =
		new UtilsHandler(RuntimeEnvironment.application);
	...
	utilsHandler.addSsh("Test", SshClientUtils.encryptSshPathAsNecessary(url),
