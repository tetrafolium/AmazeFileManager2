...
public void testGetConnectionWithUsernameAndPassword() throws IOException {
	...
	assertNotNull(SshConnectionPool.getInstance().getConnection(
			      "127.0.0.1", 22222,
			      SecurityUtils.getFingerprint(hostKeyProvider.getKeyPair().getPublic()),
			      "testuser", "testpassword", null));

	assertNull(SshConnectionPool.getInstance().getConnection(
			   "127.0.0.1", 22222,
			   SecurityUtils.getFingerprint(hostKeyProvider.getKeyPair().getPublic()),
...
public void testGetConnectionWithUrlAndKeyAuth() throws IOException {
	createSshServer("testuser", null);
	saveSshConnectionSettings("testuser", null,
	                          userKeyProvider.getKeyPair().getPrivate());
	assertNotNull(SshConnectionPool.getInstance().getConnection(
			      "ssh://testuser@127.0.0.1:22222"));
	assertNull(SshConnectionPool.getInstance().getConnection(
			   "ssh://invaliduser@127.0.0.1:22222"));
}

@Test
public void testGetConnectionWithUrlHavingComplexPassword1()
throws IOException {
...
@Test
public void testGetConnectionWithUrlHavingComplexPassword2()
throws IOException {
...
@Test
public void testGetConnectionWithUrlHavingComplexCredential1()
throws IOException {
	String validPassword = "testP@##word";
	createSshServer("testuser", validPassword);
	saveSshConnectionSettings("testuser", validPassword, null);
...
@Test
public void testGetConnectionWithUrlHavingComplexCredential2()
throws IOException {
	String validPassword = "testP@##word";
	createSshServer("testuser", validPassword);
	saveSshConnectionSettings("testuser", validPassword, null);
...
@Test
public void testGetConnectionWithUrlHavingComplexCredential3()
throws IOException {
...
@Test
public void testGetConnectionWithUrlHavingComplexCredential4()
throws IOException {
	String validUsername = "test@example.com";
...
@Test
public void testGetConnectionWithUrlHavingMinusSignInPassword1()
throws IOException {
	String validUsername = "test@example.com";
...
@Test
public void testGetConnectionWithUrlHavingMinusSignInPassword2()
throws IOException {
	String validUsername = "test@example.com";
...
@Test
public void testGetConnectionWithUrlHavingMinusSignInPassword3()
throws IOException {
	String validUsername = "test@example.com";
...
@Test
public void testGetConnectionWithUrlHavingMinusSignInPassword4()
throws IOException {
	String validUsername = "test@example.com";
...
private void createSshServer(final @NonNull String validUsername,
                             final @Nullable String validPassword)
throws IOException {
	...
	server.setPublickeyAuthenticator(
		...
		->username.equals(validUsername) &&
		key.equals(userKeyProvider.getKeyPair().getPublic()));
	server.start();
}

private void saveSshConnectionSettings(final @NonNull String validUsername,
                                       final @Nullable String validPassword,
                                       final
	...
	StringBuilder fullUri =
		new StringBuilder().append("ssh://").append(validUsername);
	...
	if (validPassword != null)
		utilsHandler.addSsh(
			"test", SshClientUtils.encryptSshPathAsNecessary(fullUri.toString()),
			SecurityUtils.getFingerprint(
				hostKeyProvider.getKeyPair().getPublic()),
			null, null);
	else
		utilsHandler.addSsh("test", fullUri.toString(),
		                    SecurityUtils.getFingerprint(
					    hostKeyProvider.getKeyPair().getPublic()),
		                    "id_rsa", privateKeyContents);
}
}
