...
class Coders {
  private static final Map<SevenZMethod, CoderBase> CODER_MAP =
      new HashMap<SevenZMethod, CoderBase>() {
        private static final long serialVersionUID = 1664829131806520867L;
        {
          ...
          put(SevenZMethod.BCJ_PPC_FILTER,
              new BCJDecoder(new PowerPCOptions()));
          ...
          put(SevenZMethod.BCJ_ARM_THUMB_FILTER,
              new BCJDecoder(new ARMThumbOptions()));
          put(SevenZMethod.BCJ_SPARC_FILTER,
              new BCJDecoder(new SPARCOptions()));
  ...
  static InputStream addDecoder(final String archiveName, final InputStream is,
  ...
  static class CopyDecoder extends CoderBase {
    ...
    InputStream decode(final String archiveName, final InputStream in,
                       final long uncompressedLength, final Coder coder,
  ...
  static class BCJDecoder extends CoderBase {
    ...
    BCJDecoder(final FilterOptions opts) { this.opts = opts; }
    ...
    InputStream decode(final String archiveName, final InputStream in,
      ...
      try {
        ...
        throw new IOException(
            "BCJ filter used in " + archiveName +
  ...
  static class DeflateDecoder extends CoderBase {
    ...
    DeflateDecoder() { super(Number.class); }
    ...
    InputStream decode(final String archiveName, final InputStream in,
      ...
      final InflaterInputStream inflaterInputStream = new InflaterInputStream(
          new SequenceInputStream(in, new ByteArrayInputStream(ONE_ZERO_BYTE)),
          inflater);
    ...
    static class DeflateDecoderOutputStream extends OutputStream {
      ...
      public DeflateDecoderOutputStream(final DeflaterOutputStream
  ...
  static class Deflate64Decoder extends CoderBase {
    Deflate64Decoder() { super(Number.class); }
  ...
  static class BZIP2Decoder extends CoderBase {
    BZIP2Decoder() { super(Number.class); }
    ...
    OutputStream encode(final OutputStream out, final Object options)
        throws IOException {
      final int blockSize = numberOptionOrDefault(
          options, BZip2CompressorOutputStream.MAX_BLOCKSIZE);
