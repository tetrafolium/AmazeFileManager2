...
public class CLI {
  ...
  private enum Mode {
    LIST("Analysing") {
      @Override
      public void takeAction(final SevenZFile archive,
      ...
      public void takeAction(final SevenZFile archive,
        ...
        try (final FileOutputStream fos = new FileOutputStream(outFile)) {
          ...
          while (off < total) {
            ...
            if (bytesRead < 1) {
              throw new IOException("reached end of entry " + entry.getName() +
                                    " after " + off + " bytes, expected " +
                                    total);
            }
            off += bytesRead;
    ...
    Mode(final String message) { this.message = message; }
    public String getMessage() { return message; }
    public abstract void takeAction(SevenZFile archive,
